        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="border border-gray-300 rounded-lg p-4">
              ...
              <div class="flex text-xs font-medium text-gray-600 mb-2 pb-2 border-b border-gray-200">
          ...
          <div>
            <div class="mb-4 h-10"></div> <!-- Spacer to align with left section -->
            ...
            <div class="border border-gray-300 rounded-lg p-4">
              ...
              <div class="space-y-2 max-h-64 overflow-y-auto">
                ...
                <div v-if="selectedFields.length === 0" class="text-sm text-gray-500 text-center py-4">
